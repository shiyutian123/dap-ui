<!--
 * @Author: DevinShi
 * @Date: 2020-02-06 09:59:06
 * @LastEditors: DevinShi
 * @LastEditTime: 2020-02-06 10:03:46
...
<template>
  <div id="app">
    ...
    <div class="mobile-toggle-wrap" style="right: 230px" @click="isMobileShow=true">
      开启移动端预览
    </div>
    <div class="mobile-toggle-wrap" @click="isMobileShow=false">
      关闭移动端预览
    </div>
